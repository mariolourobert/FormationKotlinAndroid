...
/**
 * Step 1 : Écrivez une fonction qui prend originalString et print si possible le 5e caractère
 * ou qui sinon (quelque soit la raison) print "Y a pas !".
 * Dans tous les cas, il faut print originalString.
 *
 * Step 2 : Utilisez la fonction repeat(N) {} pour vérifier que votre solution fonctionne.
