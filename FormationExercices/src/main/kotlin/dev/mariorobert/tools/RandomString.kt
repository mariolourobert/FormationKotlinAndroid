...
fun Random.nextString(length: Int = nextInt(2, 20)): String {
    val includeSpecialChars = nextBoolean()
    val alphabet = if (includeSpecialChars) {
        lowerCaseAlphabet + upperCaseAlphabet + digits + specialChars
    } else {
        lowerCaseAlphabet + upperCaseAlphabet + digits
    }
